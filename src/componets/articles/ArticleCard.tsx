            ...
            <div className="border max-w-4xl flex justify-center m-auto p-3">
                ...
                <div className="">
                    ...
                    <div className="flex items-center my-4">
                        ...
                        <div>
                            <p className="mx-4 text-lg font-bold">{<Link to="/profile/:userid" className="text-blue-700 underline">Kid</Link>} posted in {<Link to="/profile/:boardid" className="text-blue-700 underline">44Chan</Link>}</p>
                        </div>
                    </div>
                    <div className="p-3">
